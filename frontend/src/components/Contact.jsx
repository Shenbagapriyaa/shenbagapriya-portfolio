...
export default function Contact() {
  ...
  const items = [
    ...
    },
    {
      icon: <FaLinkedin />,
      label: 'LinkedIn',
      value: 'shenbagapriya-n'
    },
    {
      icon: <FaGithub />,
      label: 'GitHub',
      value: 'shenbagapriyaa'
    },
    {
      icon: <SiLeetcode />,
      label: 'LeetCode',
      value: 'shenbagapriya-12'
    },
    {
      icon: <FaMapMarkerAlt />,
      label: 'Location',
    ...
    <section id="contact" className="section-shell">
      ...
      >
        ...
        <p className="text-slate text-[15.5px] mt-3 max-w-lg">
          Open to Software Developer opportunities where I can apply my programming
        ...
        >
          ...
          {items.map((item) => (
            ...
            >
              ...
              <div className="w-10 h-10 rounded-xl glass flex items-center justify-center text-base">
                {item.icon}
              </div>
              ...
              <div>
                ...
                <span className="text-[12.8px] text-slate">
                  {item.value}
                </span>
              </div>
        ...
        >
          ...
          <div className="grid sm:grid-cols-2 gap-3.5 mb-3.5">
            ...
            <input
              ...
              className="w-full px-4 py-3 rounded-2xl border border-black/[0.08] bg-white/70 text-sm outline-none"
            />
...
/>
          ...
          <textarea
            ...
            className="w-full px-4 py-3 mb-3.5 rounded-2xl border border-black/[0.08] bg-white/70 text-sm outline-none resize-y"
